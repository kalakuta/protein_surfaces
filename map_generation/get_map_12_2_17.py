...
# reduce data set to points within 30 angstroms of centre point
close_points = {}
for point in surface:
	a = numpy.array(surface[point])
	b = numpy.array(surface[centre_point])
	if numpy.linalg.norm(a-b) < 20:
...
geodesic_distances = scipy.sparse.csgraph.dijkstra(sparse_distances, indices = centre_index)
...
geo_dist = {}
for i in index:
	if geodesic_distances.item(i) < 50:
		geo_dist[i] = geodesic_distances.item(i)
