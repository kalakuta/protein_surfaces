# reads two cell_scores files and finds their h_acc_distance score minimised over
...
def distance(a,b, translation, rotation):
	...
	while True:
		...
		h_acc_value = float(line.split(':')[3])
		map1[cell] = h_acc_value
