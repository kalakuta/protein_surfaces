# reads two cell_scores files and finds their curvature_distance score minimised over
...
def distance(a,b,translation,rotation):
	...
	while True:
		...
		curvature_value = float(line.split(':')[6])
		map1[cell] = curvature_value
