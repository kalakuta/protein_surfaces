# reads two cell_scores files and finds their distance score minimised over
...
# distance(a,b) calculates the mean absolute difference between values in lists a and b
