# reads two cell_scores files and finds their h_don_distance score minimised over
...
def distance(a,b, translation, rotation):
	...
	while True:
		...
		h_don_value = float(line.split(':')[4])
		map1[cell] = h_don_value
